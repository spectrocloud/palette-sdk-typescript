...
import type {
  ...
  AwsFindImageRequest,
  AwsHostResourceGroups,
  AwsHrgCapacityValidationRequest,
  AwsHrgCapacityValidationResponse,
  AwsImage,
  AwsInstanceTypes,
  AwsKeyPairs,
  AwsKmsKeyEntity,
  AwsKmsKeys,
  AwsLicenseConfigurations,
  AwsMachine,
  AwsMachines,
  AwsPolicies,
  AwsPolicyArnsSpec,
  ...
  V1AwsHostResourceGroupCapacityValidationParams,
  V1AwsHostResourceGroupLicensesParams,
  V1AwsHostResourceGroupsParams,
 ...
 */
export const getV1AwsHostResourceGroupsUrl = (region: string,
    params: V1AwsHostResourceGroupsParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/v1/clouds/aws/regions/${region}/resourceGroups?${stringifiedParams}` : `/v1/clouds/aws/regions/${region}/resourceGroups`
}

export const v1AwsHostResourceGroups = async (region: string,
    params: V1AwsHostResourceGroupsParams, options?: RequestInit): Promise<AwsHostResourceGroups> => {
  
  return customFetch<AwsHostResourceGroups>(getV1AwsHostResourceGroupsUrl(region,params),
  {      
    ...options,
    method: 'GET'
 ...
 */
export const getV1AwsHostResourceGroupLicensesUrl = (region: string,
    params: V1AwsHostResourceGroupLicensesParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/v1/clouds/aws/regions/${region}/resourceGroups/licenses?${stringifiedParams}` : `/v1/clouds/aws/regions/${region}/resourceGroups/licenses`
}

export const v1AwsHostResourceGroupLicenses = async (region: string,
    params: V1AwsHostResourceGroupLicensesParams, options?: RequestInit): Promise<AwsLicenseConfigurations> => {
  
  return customFetch<AwsLicenseConfigurations>(getV1AwsHostResourceGroupLicensesUrl(region,params),
  {      
    ...options,
    method: 'GET'
...
/**
 * @summary Validates available capacity for an instance type in a Host Resource Group
 */
export const getV1AwsHostResourceGroupCapacityValidationUrl = (region: string,
    params: V1AwsHostResourceGroupCapacityValidationParams,) => {
  const normalizedParams = new URLSearchParams();
  ...
  return stringifiedParams.length > 0 ? `/v1/clouds/aws/regions/${region}/resourceGroups/validateCapacity?${stringifiedParams}` : `/v1/clouds/aws/regions/${region}/resourceGroups/validateCapacity`
}

export const v1AwsHostResourceGroupCapacityValidation = async (region: string,
    awsHrgCapacityValidationRequest: AwsHrgCapacityValidationRequest,
    params: V1AwsHostResourceGroupCapacityValidationParams, options?: RequestInit): Promise<AwsHrgCapacityValidationResponse> => {
  
  return customFetch<AwsHrgCapacityValidationResponse>(getV1AwsHostResourceGroupCapacityValidationUrl(region,params),
  {      
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
